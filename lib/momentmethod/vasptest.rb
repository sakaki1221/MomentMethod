  ...
  for i in 0..10
    ...
    for change in 1..5 #width to displace
      for same in 1..200
        ...
        gap[change][same] = (same-1)*(10**(-(1+change))).to_f #1e0バージョン
        ...
        #p a1
        p " "
        p k = calc_k_noBOLTZ(a1,a2,@structure)
        ...
        p u0 = calc_u0(a1,a2)/BOLTZ2#元のプログラムがu0はKだからとりあえず戻す．
      ...
      aa1[change] = aa1[change] - (10**(-(1+change))).to_f
      aa2[change] = aa1[change]*sqrt(2)
